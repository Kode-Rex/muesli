...
struct SwiftDataTests {
    ...
    @MainActor func sortNotesByTimestamp() async throws {
        ...
        let notes = [
            ...
            Note(title: "Oldest", content: "Content", timestamp: now.addingTimeInterval(-3_600), conferenceName: nil, sessionType: "note", isArchived: false),
            Note(title: "Middle", content: "Content", timestamp: now.addingTimeInterval(-1_800), conferenceName: nil, sessionType: "note", isArchived: false)
        ]
